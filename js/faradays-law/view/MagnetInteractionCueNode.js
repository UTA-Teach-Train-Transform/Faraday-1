...
import TextKeyNode from '../../../../scenery-tech/js/keyboard/TextKeyNode.js';
...
const TEXT_KEY_OPTIONS = { font: new techFont( 14 ), forceSquareKey: true, keyHeight: KEY_HEIGHT };
...
function MagnetInteractionCueNode() {
  ...
  const a11yEnabled = tech.joist.sim.supportsInteractiveDescriptions;
