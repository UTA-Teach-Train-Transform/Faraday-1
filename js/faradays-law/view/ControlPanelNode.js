...
import ResetAllButton from '../../../../scenery-tech/js/buttons/ResetAllButton.js';
...
function ControlPanelNode( model, tandem ) {
  ...
  const coilButtonGroupContents = [ {
    ...
    techioDocumentation: 'Radio button that selects a single coil.',
    ...
    techioDocumentation: 'Radio button that selects double coils.',
  ...
  const coilRadioButtonGroup = new RadioButtonGroup( model.topCoilVisibleProperty, coilButtonGroupContents, {
    ...
    techioDocumentation: 'Radio button group that selects between one or two coils.',
    containerTagName: 'li',
  ...
  const showVoltmeterLabel = new Text( faradaysLawVoltmeterString, { font: new techFont( 16 ) } );
  ...
  const voltmeterCheckbox = new Checkbox( showVoltmeterLabel, model.voltmeterVisibleProperty, {
    ...
    techioDocumentation: 'Checkbox that selects whether the voltmeter will be shown.',
    containerTagName: 'li',
    labelTagName: 'label',
  ...
  model.voltmeterVisibleProperty.lazyLink( function( showVoltmeter ) {
    ...
    // tech.joist.sim.utteranceQueue.addToBack( StringUtils.fillIn( voltmeterAlertPatternString, { attachmentState } ) );
  } );

  // Create the label for the "Show Field Lines" checkbox, scaling it if it's too long.
  const showFieldLinesLabel = new Text( faradaysLawShowFieldLinesString, { font: new techFont( 16 ) } );
  ...
  const fieldLinesCheckbox = new Checkbox( showFieldLinesLabel, model.magnet.fieldLinesVisibleProperty, {
    ...
    techioDocumentation: 'Checkbox that selects whether the magnetic field lines will be shown.',
    containerTagName: 'li',
    labelTagName: 'label',
