...
function Magnet( tandem ) {
  ...
  this.positionProperty = new Vector2Property( new Vector2( 647, 219 ), {
    ...
    techioDocumentation: 'The position of the center of the bar magnet in view coordinates',
  ...
  this.orientationProperty = new Property( OrientationEnum.NS, {
    ...
    techioDocumentation: 'The direction the bar magnet is oriented',
    techioType: PropertyIO( StringIO ) // Should we create OrientationEnumIO?
  } );
  ...
  this.fieldLinesVisibleProperty = new BooleanProperty( false, {
    ...
    techioDocumentation: 'True if the field lines are visible'
  } );
}
